...
def extract_metadata(folder_path, file_types, csv_save_path):
    ...
    for idx, file in enumerate(files, 1):
        try:
            ...
            file_metadata.append([file_name, file_ext, author, size_mb, creation_date, modification_date, access_date])
...
# Als CSV speichern
    with open(csv_save_path, mode='w', newline='', encoding='utf-8-sig') as f:
        ...
        writer.writerow(["Dateiname", "Dateityp", "Autor", "Größe in MB", "Erstelldatum", "Änderungsdatum", "Letzter Zugriff"])
